 ...
 * <p>
 * <h2>Motivation</h2>
 * The default behaviour of most XmlAdapter in the JAXB reference implementation (RI) is to report a non-fatal
 * validation error if a type mismatch / conversion error occurs on unmarshalling, leaving the target field set to its
...
public class IntegerXmlAdapter extends XmlAdapter<String, Integer> {
   ...
   * {@inheritDoc}
   * 
   * @throws NumberFormatException if the string to be unmarshalled is a non-integer string. The JAXB API states 
   * that callers of this adapter are responsible for catching this exception and reporting it to any configured
   ...
   * {@inheritDoc}
   * <p>
   * This implementation replicates the marshalling behaviour of the standard XmlAdapter provided in the JAXB RI - 
   * null Integers result in a null String. 
   */
  @Override
